...
export default {
  ...
  argTypes: {
    ...
    defaultTab: {
      description: 'ID of the tab that will be selected by default',
      control: 'text'
    },
    tab: {
      description: 'ID of the currently selected tab when used as a controlled component',
      control: 'text'
    },
    onChange: {
      description: 'Callback function that is called when the selected tab changes',
      action: 'changed',
      control: false
    }
  },
  ...
  <Tabs {...args}>
    ...
    <Tabs.contentGroup>
      ...
      <Tabs.content id="3">
        ...
        Pellentesque interdum sed ante sollicitudin feugiat. Curabitur vitae pretium enim. Maecenas convallis urna vitae
        augue viverra ut fermentum tortor mattis. Nam laoreet aliquet condimentum. Quisque nec ornare nulla. Cras quis
        ante nec nunc varius varius nec non ante.
      </Tabs.content>
      <Tabs.content id="4">
        Morbi in sem quis dui placerat ornare. Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. Sed
        arcu. Cras consequat. Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna
      ...
      <Tabs.content id="6">
        ...
        Nam nulla quam, gravida non, commodo a, sodales sit amet, nisi. Pellentesque fermentum, magna a pellentesque
        adipiscing, magna mi ornare ligula, et fringilla orci augue vitae magna. Donec egestas, augue vel cursus
        vestibulum, sapien pede bibendum ligula.
      </Tabs.content>
    </Tabs.contentGroup>
  </Tabs>
);
...
const HorizontalTemplate: StoryFn<typeof Tabs> = (args) => (
  <Tabs {...args}>
    <Tabs.tabGroup>
      <Tabs.tab id="1">About Us</Tabs.tab>
      <Tabs.tab id="2">Services</Tabs.tab>
